# How to Reveal the back layer programmatically in the .NET MAUI Backdrop Page (SfBackdropPage)?
This repository contains a sample that explain how to reveal the back layer programmatically in the [.NET MAUI SfBackdropPage](https://help.syncfusion.com/maui/backdrop/getting-started) control.

## Syncfusion controls

This project used the following Syncfusion control(s):
* [Syncfusion .NET MAUI BackdropPage](https://www.syncfusion.com/maui-controls/maui-backdrop)
